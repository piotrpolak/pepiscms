...
class Module extends AdminController
{
    ...
    public function make()
    {
        $view = $this->_get_view();
        $this->assign('view', $view);
        $this->assign('title', $this->lang->line('modules_make_a_new_module'));
        $this->assign('success', FALSE);

        $database_groups = array('0' => $this->lang->line('modules_database_group_implicit'));
        ...
        $this->formbuilder->setTitle($this->lang->line('modules_make_a_new_module'));
        $this->formbuilder->setBackLink(admin_url() . 'module');
        ...
        $this->formbuilder->setDefinition(array(
            'database_table_name' => array(
                'label' => $this->lang->line('modules_database_table_name'),
            ),
            'module_name' => array(
                'label' => $this->lang->line('modules_module_name'),
                'description' => $this->lang->line('modules_module_name_description'),
                'validation_rules' => '',
            ),
            'parse_database_schema' => array(
                ...
                'validation_rules' => '',
                'label' => $this->lang->line('modules_parse_database_schema'),
            ),
            ...
            'module_type' => array(
                ...
                'validation_rules' => '',
                'label' => $this->lang->line('modules_module_type'),
                'values' => array(
                    'crud' => $this->lang->line('modules_module_type_crud'),
                    'default' => $this->lang->line('modules_module_type_basic'))
            ),
            'database_group' => array(
                'input_type' => FormBuilder::SELECTBOX,
                'values' => $database_groups,
                'label' => $this->lang->line('modules_database_group'),
            ),
            'translations' => array(
                'input_type' => FormBuilder::MULTIPLECHECKBOX,
                'values' => array('polish' => 'Polish', 'english' => 'English'),
                'input_default_value' => 'polish',
                'label' => $this->lang->line('modules_translations'),
            ),
            'generate_public_controller' => array(
                'input_type' => FormBuilder::CHECKBOX,
                'validation_rules' => '',
                'label' => $this->lang->line('modules_generate_public_controller'),
            ),
        ));
