            ...
            <ul class="dashboard_actions clear">
                <?php foreach($dashboard_elements as $dashboard_element): ?>
                    <?=dashboard_box(
                        ...
                        isset($dashboard_element['icon']) && $dashboard_element['icon'] ? $dashboard_element['icon'] : (isset($dashboard_element['controller']) ? module_icon_url($dashboard_element['controller']) : FALSE),
