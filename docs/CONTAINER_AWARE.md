...
If you can't (or don't want) to extend the ContainerAware class then you can implement your own magig method `__get()'
and to reuse a static helper provided by ContainerAware:
