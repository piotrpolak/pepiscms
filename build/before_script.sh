...
mysql -e 'create database pepiscms;' && \
    ...
    mkdir app && cd app && cp -a ../vendor . && mkdir -p ./vendor/piotrpolak/pepiscms && cp -a ../pepiscms ./vendor/piotrpolak/pepiscms/ && cp -a ../composer.json ./vendor/piotrpolak/pepiscms/ && cp -a ../build/travis-composer.json ./composer.json && \
    ...
    rm -rf vendor/piotrpolak/pepiscms/pepiscms/ && cp -a ../pepiscms ./vendor/piotrpolak/pepiscms/  && \
